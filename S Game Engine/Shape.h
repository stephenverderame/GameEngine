...
protected:
	...
	glm::vec4 color;
	//Texture not owned by this object
	Texture * tex;
public:
	Shape();
	/**
	* @param tex, pass the address of or pointer to a Texture. Shape is not an RAII for Texture*
	*/
	void setTexture(Texture * tex);
	void setColor(glm::vec4 c);
	void draw(const Shader * s) const override = 0;
	virtual ~Shape();
};
